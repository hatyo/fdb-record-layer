...
public class ExplainPlanVisitor extends ExplainTokens implements RecordQueryPlanVisitor<ExplainTokens> {
    ...
    public ExplainTokens visitRecursiveDfsJoinPlan(@Nonnull final RecordQueryRecursiveDfsJoinPlan recursiveDfsJoinPlan) {
        ...
        final var dfsTraversalOrder = recursiveDfsJoinPlan.isPreorder() ? "PREORDER" : "POSTORDER";
        addKeyword("RUNION-DFS").addWhitespace().addKeyword(dfsTraversalOrder).addWhitespace();
